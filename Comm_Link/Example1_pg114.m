...
fprintf(sport, 'Ae3<');     % Select second rotation axis No:3
fprintf(sport, 'Pat05000<');% Set target of first axis :50.00 deg  
fprintf(sport, 'Pet35180<');% Set target of first axis:351.8 deg 
fprintf(sport, 'Daf<');     % Set direction of first axis: forward  
fprintf(sport, 'Der<');     % Set direction of second axis: reverse
fprintf(sport, 'Va00876<'); % Set travel velocity of axis a: 87.6% 
