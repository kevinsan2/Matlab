...
% Auto-generated by MATLAB on 2014/06/29 16:29:36
function [yoe,doe,moe,frac] = importFirstLineFunction(filename)
...
formatSpec = '%*18s%2s%12s%13s%8s%6s%2s%2s%s%[^\n\r]';
...
moe = 6;
frac = cell2mat(raw(:, 2));
% firstDerivativeMeanMotion = cell2mat(raw(:, 3));
% secondDerivativeofMeanMotion = cell2mat(raw(:, 4));
% dragTerm = cell2mat(raw(:, 5));
% exponentDrag = cell2mat(raw(:, 6));
% ephermerisType = cell2mat(raw(:, 7));
% elementNumber = cell2mat(raw(:, 8));
